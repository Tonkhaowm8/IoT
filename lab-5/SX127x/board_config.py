...
class BOARD:
    ...
    def setup():
        ...
        #GPIO.setup(BOARD.DIO1, GPIO.IN, pull_up_down=GPIO.PUD_DOWN)
        #GPIO.setup(BOARD.DIO2, GPIO.IN, pull_up_down=GPIO.PUD_DOWN)
        #GPIO.setup(BOARD.DIO3, GPIO.IN, pull_up_down=GPIO.PUD_DOWN)
